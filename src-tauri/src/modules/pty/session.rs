...
const OVERFLOW_NOTICE: &[u8] = b"\x1bc\x1b[2m[Gear: dropped output due to backpressure]\x1b[0m\r\n";
...
pub fn spawn(
    ...
    let cmd = shell_init::build_command(cwd, workspace, custom_shell)?;
