...
export default function App() {
	...
	const isBlockTab =
		activeTab?.kind === "terminal" && activeTab.blocks === true;
	const blockLeafId =
		activeTab?.kind === "terminal" && activeTab.blocks === true
				...
				<div className="relative flex h-screen flex-col overflow-hidden bg-background text-foreground">
					{!zenMode && (
						<div
							...
							className="h-[2px] w-full shrink-0 bg-gradient-to-r from-primary/30 via-primary to-primary/30"
						/>
					)}
					{!zenMode && (
						<Header
								...
								<div className="flex h-full min-h-0 flex-col p-2 pl-1 pr-1">
									...
									{isBlockTab && blockLeafId != null ? (
										<WorkspaceInputBar
											...
											onConnect={() => openSettingsTab("models")}
										/>
									) : keysLoaded ? (
										<motion.div
											data-ai-input-bar
