...
// A finished agent shouldn't badge its tab forever — fade back to idle so the
// marker reads as "just completed" rather than permanent state.
...
// arms via the Claude Code / Codex / Gemini OSC 777 marker and reports per-pty
// lifecycle: started, working, attention, finished, exited.
export function ensureAgentActivityListener(
  ...
  bound = true;
  void listen<AgentSignal>("gear:agent-signal", (e) => {
