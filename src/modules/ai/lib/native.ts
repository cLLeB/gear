...
export const native = {
  ...
  gitCreateBranch: (repoRoot: string, branch: string, startPoint?: string) =>
  ...
  gitListStash: (repoRoot: string) =>
    invoke<Array<{ index: number; sha: string; message: string }>>(
      "git_list_stash",
      { repoRoot, workspace: currentWorkspaceEnv() },
    ),
  gitPushStash: (repoRoot: string, message?: string) =>
    invoke<void>("git_push_stash", {
      repoRoot,
      message: message ?? null,
      workspace: currentWorkspaceEnv(),
    }),
  gitPopStash: (repoRoot: string, index: number) =>
    invoke<void>("git_pop_stash", {
      repoRoot,
      index,
      workspace: currentWorkspaceEnv(),
    }),
  gitDropStash: (repoRoot: string, index: number) =>
    invoke<void>("git_drop_stash", {
      repoRoot,
      index,
      workspace: currentWorkspaceEnv(),
    }),
