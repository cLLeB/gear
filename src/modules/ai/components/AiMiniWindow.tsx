...
function SessionPicker({ messages }: { messages?: UIMessage[] }) {
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="min-w-56">
        ...
        {messages && messages.length > 0 && (
          <DropdownMenuItem
            onSelect={() =>
              exportConversationAsMarkdown(messages, active.title || "conversation")
            }
            className="gap-2 text-xs"
          >
    ...
    <div className="flex flex-1 flex-col items-center justify-center gap-6 px-8 py-10 text-center">
      ...
      <div className="space-y-1.5">
        ...
        <p className="max-w-[18rem] text-[11.5px] leading-relaxed text-muted-foreground">
          Gear sees the active terminal — cwd, recent commands, and output.
        </p>
      </div>
