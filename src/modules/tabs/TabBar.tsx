...
type Props = {
  ...
  onNewEditor: () => void;
  onNewGitGraph: () => void;
  /** Open N terminal panes in a new tab, each running the agent's command. */
...
/** Live agent phase for a terminal tab, aggregated across its panes.
 * Private terminals are excluded — they shouldn't advertise activity. */
